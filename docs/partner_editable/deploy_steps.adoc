...
[cols="1,1"]
|===
^|https://fwd.aws/me7zn?[Deploy {partner-product-short-name} into a new VPC on AWS^]
^|https://fwd.aws/QD58p?[View template^]

^|https://fwd.aws/e6RPG?[Deploy {partner-product-short-name} into an existing VPC on AWS^]
^|https://fwd.aws/8KwVG?[View template^]
|===
+
