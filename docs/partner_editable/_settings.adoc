...
:quickstart-project-name: quickstart-data-robot-automl-platform
:partner-product-name: DataRobot AutoML 7.1
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: DataRobot AutoML 7.1
// If there's no partner, comment partner-company-name.
:partner-company-name: DataRobot, Inc.
:doc-month: July
:doc-year: 2021
...
:partner-contributors: Wes Wagner, Dennis Whitney, {partner-company-name}
